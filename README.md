...
You can use the two provided test PDFs inside the `Test_PDFs/` directory to test the document upload and Q&A features.

### 📊 Data Analysis PDF Questions
- **Section 1:** What is the main goal of Data Analysis?
- **Section 2:** Which analytics type answers the question "What happened?"
- **Section 3:** What is the first step in the data analysis lifecycle?
- **Section 4:** Name two characteristics of high-quality data.
- **Section 5:** Why is data privacy important in data analysis?

### 🤖 Machine Learning PDF Questions
- **Section 1:** How does Machine Learning make decisions differently from traditional programming?
- **Section 2:** What type of dataset is used in Supervised Learning?
- **Section 3:** What is done during the Data Collection step?
- **Section 4:** What does "overfitting" mean in simple terms?
- **Section 5:** Name one technique used to make ML models explainable.
